...
--
-- Host: localhost
-- Generation Time: Dec 26, 2016 at 08:08 PM
...
CREATE TABLE IF NOT EXISTS `i_t_outbound` (
  `id` int(10) NOT NULL,
...
(2, 'purchaseorder', '00004', 4, 'JU001', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'payorder', '00006', 6, 'JU001', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'posretail', 'R00001', 1, 'JU001', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'posgrosir', 'G00001', 1, 'JU001', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'customer', '00001', 1, 'JU001', NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, '0001', 'Product A', 'Product A', 7, 'JU001', '2016-11-25 10:05:11', NULL, NULL, NULL, NULL, NULL, 500, NULL),
(2, 'OK', 'kkajjsk Update', 'jsjsjsj', 1, 'JU001', '2016-11-27 12:55:40', NULL, '2016-11-27 12:55:53', NULL, '2016-11-27 12:56:01', 0, 25, NULL),
...
(1, 'Belum Dibayar', 'Belum Dibayar', 'JU001', '2016-11-20 15:56:36', 1, NULL, NULL, NULL, NULL),
(2, 'Telah Dibayar', 'Telah Dibayar', 'JU001', '2016-11-20 15:56:52', 1, NULL, NULL, NULL, NULL),
(3, 'Closed', 'Closed', 'JU001', '2016-11-20 15:56:52', 1, NULL, NULL, NULL, NULL);
...
(4, '00004', '2016-12-26', '2017-01-09', NULL, '00001', 1, '', 2000000.00, 100000.00, 2100000.00, NULL, 'JU001', '2016-12-25 14:56:26', 1, NULL, NULL, NULL, NULL),
(5, '00005', '2016-12-26', '2017-01-09', NULL, '00001', 2, '', 2200000.00, 0.00, 2200000.00, 2200000.00, 'JU001', '2016-12-25 15:00:31', 1, '2016-12-25 16:03:18', 1, NULL, NULL);
...
(8, '00004', '0001', '1', 50, 20000.00, 1, 1, 1, 'JU001', '2016-12-25 14:56:26', 1, NULL, NULL, NULL, NULL),
(9, '00004', '0002', '2', 0, 0.00, 0, 1, 2, 'JU001', '2016-12-25 14:56:26', 1, NULL, NULL, NULL, NULL),
(10, '00004', '0002', '2', 100, 10000.00, 0, 1, 3, 'JU001', '2016-12-25 14:56:26', 1, NULL, NULL, NULL, NULL),
(11, '00005', '0001', '1', 20, 10000.00, 0, 1, 1, 'JU001', '2016-12-25 15:00:31', 1, NULL, NULL, NULL, NULL),
(12, '00005', '0002', '2', 100, 20000.00, 0, 1, 2, 'JU001', '2016-12-25 15:00:32', 1, NULL, NULL, NULL, NULL);
...
(7, '00007', '00005', '2016-12-25 00:00:00', '00001', 1100000.00, 'JU001', '2016-12-25 15:03:45', 1, NULL, NULL, NULL, NULL),
(8, '00008', '00005', '2016-12-25 00:00:00', '00001', 1100000.00, 'JU001', '2016-12-25 16:03:18', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `sa_m_customer` (`id`, `cust_id`, `cust_nama`, `cust_alamat`, `cust_hp`, `cust_status`, `kd_jns_usaha`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
(1, '00001', 'Joni', 'Tambun', '08998998889', 'AKTIF', 'JU001', '2016-12-19', 1, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `sa_t_pos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sa_t_pos` (`id`, `sale_no`, `sale_tgl`, `cust_id`, `sale_type`, `sale_subtotal`, `sale_ppn`, `sale_total`, `sale_bayar`, `kd_jns_usaha`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
(1, 'R00001', '2016-12-19', NULL, 'RETAIL', 90000.00, 5000.00, 95000.00, 100000.00, 'JU001', '2016-12-19', 1, NULL, NULL, NULL, NULL),
(2, 'G00001', '2016-12-19', '1', 'GROSIR', 30000.00, 3000.00, 33000.00, 40000.00, 'JU001', '2016-12-19', 1, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `sa_t_posdetail` (
  ...
  `satuan_kd` varchar(255) DEFAULT NULL,
  `qty` double(12,2) DEFAULT NULL,
  `harga_satuan` double(12,2) DEFAULT NULL,
...
INSERT INTO `sa_t_posdetail` (`id`, `sale_no`, `brg_kd`, `satuan_kd`, `qty`, `harga_satuan`, `ppn`, `diskon`, `index`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
(1, 'R00001', '0001', '1', 10.00, 5000.00, 1.00, NULL, 1, '2016-12-19', 1, NULL, NULL, NULL, NULL),
(2, 'R00001', '0002', '2', 5.00, 8000.00, 0.00, NULL, 2, '2016-12-19', 1, NULL, NULL, NULL, NULL),
(3, 'G00001', '0001', '1', 60.00, 500.00, 1.00, NULL, 1, '2016-12-19', 1, NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `sa_t_pos_pembayaran`
--

CREATE TABLE IF NOT EXISTS `sa_t_pos_pembayaran` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pembayaran_no` varchar(20) DEFAULT NULL,
  `sale_no` varchar(20) DEFAULT NULL,
  `tgl_bayar` date DEFAULT NULL,
  `cust_id` varchar(20) DEFAULT NULL,
  `pembayaran_total` float(18,0) DEFAULT NULL,
  `kd_jns_usaha` varchar(20) DEFAULT NULL,
  `created_at` date DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` date DEFAULT NULL,
...
--
-- Dumping data for table `sa_t_pos_pembayaran`
--

INSERT INTO `sa_t_pos_pembayaran` (`id`, `pembayaran_no`, `sale_no`, `tgl_bayar`, `cust_id`, `pembayaran_total`, `kd_jns_usaha`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
(1, '00001', 'G00001', '2016-12-19', '00001', 10000, 'JU001', '2016-12-19', 1, NULL, NULL, NULL, NULL),
(2, '00002', 'G00001', '2016-12-20', '00001', 15000, 'JU001', '2016-12-20', 1, NULL, NULL, NULL, NULL),
(3, '00003', 'G00001', '2016-12-23', '00001', 5000, 'JU001', '2016-12-23', 1, NULL, NULL, NULL, NULL),
(4, '00004', 'G00001', '2016-12-24', '00001', 2000, 'JU001', '2016-12-24', 1, NULL, NULL, NULL, NULL),
(5, '00005', 'G00002', '2016-12-22', '00002', 15000, 'JU001', '2016-12-26', 1, NULL, NULL, NULL, NULL),
(6, '00006', 'G00003', '2016-12-26', '00001', 90000, 'JU001', '2016-12-26', 1, NULL, NULL, NULL, NULL);
...
--
-- Stand-in structure for view `v_i_outbound_grid`
--
CREATE TABLE IF NOT EXISTS `v_i_outbound_grid` (
`id_outbound` varchar(20)
,`date_out` datetime
,`no_trx_sales` varchar(200)
,`brg_nama` varchar(255)
,`jml_in` int(10)
,`kd_jns_usaha` varchar(255)
,`deleted_by` int(11)
...
--
-- Stand-in structure for view `v_sa_t_kartupiutang`
--
CREATE TABLE IF NOT EXISTS `v_sa_t_kartupiutang` (
`id` int(11)
,`pembayaran_no` varchar(20)
,`sale_no` varchar(20)
,`cust_id` varchar(20)
,`cust_nama` varchar(50)
,`tgl_bayar` date
,`sale_total` double(12,2)
,`total_bayar` double(17,0)
,`sisa_bayar` double(19,2)
,`kd_jns_usaha` varchar(20)
,`deleted_by` int(11)
,`deleted_at` date
);
-- --------------------------------------------------------
...
--
DROP TABLE IF EXISTS `v_i_outbound_grid`;
...
--
-- Structure for view `v_sa_t_kartupiutang`
--
DROP TABLE IF EXISTS `v_sa_t_kartupiutang`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_sa_t_kartupiutang` AS select `a`.`id` AS `id`,`a`.`pembayaran_no` AS `pembayaran_no`,`a`.`sale_no` AS `sale_no`,`a`.`cust_id` AS `cust_id`,`c`.`cust_nama` AS `cust_nama`,`a`.`tgl_bayar` AS `tgl_bayar`,`b`.`sale_total` AS `sale_total`,sum(`a`.`pembayaran_total`) AS `total_bayar`,(`b`.`sale_total` - sum(`a`.`pembayaran_total`)) AS `sisa_bayar`,`a`.`kd_jns_usaha` AS `kd_jns_usaha`,`a`.`deleted_by` AS `deleted_by`,`a`.`deleted_at` AS `deleted_at` from ((`sa_t_pos_pembayaran` `a` left join `sa_t_pos` `b` on((`a`.`sale_no` = `b`.`sale_no`))) left join `sa_m_customer` `c` on((`a`.`cust_id` = `c`.`cust_id`))) group by `a`.`sale_no`;

    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('inventory/data_outbound/add');?>"><i class="fa fa-plus text-aqua"></i>Tambah Data</a></li>
            <li><a href="<?php echo base_url('inventory/data_outbound');?>"><i class="fa fa-list text-aqua"></i> List Data Outbound</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('hrm/absensi');?>"><i class="fa fa-circle-o"></i> Absensi</a></li>
            <li><a href="<?php echo base_url('hrm/penggajian');?>"><i class="fa fa-circle-o"></i> Penggajian</a></li>

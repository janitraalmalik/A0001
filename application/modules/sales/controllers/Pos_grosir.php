...
class Pos_grosir extends MY_Controller {
    
    public function __construct() {
        parent::__construct();
        date_default_timezone_set('Asia/Jakarta');
        $this->page->use_directory();
        $this->moduleTitle = 'Penjualan Grosir';
        $this->saletype = 'Grosir';
    ...
    public function index() {
       ...
       $this->page->view('pos/indexGrosir', array (
    ...
    public function get_data(){
        ...
        foreach ($list as $grid) {
            ...
            $row[] = getNameCustomer($grid->cust_id,$this->_roleCode);
            $row[] = $grid->sale_type;
    ...
    private function form($action = 'insert', $viewTPL='formGrosir', $id = ''){
        ...
        $contect = array(
                        ...
                        'customerData'     => $this->db->query('select * from sa_m_customer where deleted_at is null')->result(),
                        'codePosGrosir'    => generateCodePos($this->_roleCode,'posgrosir'),
    ...
    public function insert(){       
        ...
        if($this->form_validation->run()){
            ...
            $generateCodePos = generateCodePos($this->_roleCode,'posgrosir');
            ...
            saveGenerateCodePos($this->_roleCode,'posgrosir');
...
//            redirect('setting/users/add');       
    ...
    public function cetak($id){        
        ...
        $this->pdf->load_view('Pos/PosGrosirFormPDF.php',array (
                                   'moduleTitle'      => $this->moduleTitle,
                                   'contentData'   => $contentData,
                                   'contentDataDetail'   => $contentDataDetail

...
<section class="content">
    <form method="post" target="_blank" action="<?php echo base_url();?>hrm/ReportPinjaman/print_pdf" id="dataForm" class="form-horizontal row-form">
		...
		<div class="form-group">
    		<label class="col-sm-2 control-label input-sm">Periode Pinjaman</label>
    		<div class="col-sm-3">

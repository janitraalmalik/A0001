...
class Outbound_model extends MY_Model {

	private $table 			= 'v_i_outbound_grid';
	private $column_order 	= array('id_outbound','date_out',null,'brg_nama',null,null,null,null,null);
	private $column_search 	= array('id_outbound','brg_nama','date_out');  
	private $order 			= array('date_out' => 'desc'); 

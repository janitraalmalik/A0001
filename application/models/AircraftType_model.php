...
class AircraftType_model extends MY_Model {
	
	private $table 			= 'm_aircraft_type';
	private $column_order 	= array(null,'name_aircraft','id_aircraft_manufacture_fk',null);
	...
	public function list_name() {
		$this->db->select('id, name_aircraft');

...
class FaultTypes_model extends MY_Model {
	
	private $table 			= 'm_faultType';
	private $column_order 	= array(null,'fCode','fName','fType',null);
	private $column_search 	= array('id','fCode','fName','fType',null);  

...
class SalesKartuPiutang_model extends MY_Model {

	private $table 			= 'v_sa_t_kartupiutang';
	private $column_order 	= array(null,'pembayaran_no','sale_no','cust_id','cust_nama','tgl_bayar','sale_total','total_bayar','sisa_bayar',null);
	private $column_search 	= array('pembayaran_no','sale_no','cust_id','cust_nama','tgl_bayar','sale_total','total_bayar','sisa_bayar');  
